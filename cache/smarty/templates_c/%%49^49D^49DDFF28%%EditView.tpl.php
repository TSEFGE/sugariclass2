<?php /* Smarty version 2.6.11, created on 2017-10-12 00:08:36
         compiled from cache/modules/Contacts/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/Contacts/EditView.tpl', 43, false),array('modifier', 'default', 'cache/modules/Contacts/EditView.tpl', 54, false),array('modifier', 'strip_semicolon', 'cache/modules/Contacts/EditView.tpl', 72, false),array('modifier', 'lookup', 'cache/modules/Contacts/EditView.tpl', 226, false),array('modifier', 'count', 'cache/modules/Contacts/EditView.tpl', 306, false),array('function', 'sugar_include', 'cache/modules/Contacts/EditView.tpl', 49, false),array('function', 'counter', 'cache/modules/Contacts/EditView.tpl', 55, false),array('function', 'sugar_getimagepath', 'cache/modules/Contacts/EditView.tpl', 58, false),array('function', 'sugar_translate', 'cache/modules/Contacts/EditView.tpl', 61, false),array('function', 'html_options', 'cache/modules/Contacts/EditView.tpl', 78, false),array('function', 'sugar_getimage', 'cache/modules/Contacts/EditView.tpl', 1301, false),)), $this); ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='ultimo_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ULTIMO','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (empty ( $this->_tpl_vars['fields']['ultimo_c']['value'] )):  $this->assign('value', $this->_tpl_vars['fields']['ultimo_c']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ultimo_c']['value']);  endif; ?>  
<textarea  id='<?php echo $this->_tpl_vars['fields']['ultimo_c']['name']; ?>
' name='<?php echo $this->_tpl_vars['fields']['ultimo_c']['name']; ?>
'
rows="1" 
cols="40" 
title='&amp;Uacute;ltimo Contacto' tabindex="0" 
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='curso_c_label' width='12.5%' scope="col">
...
<select name="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
" 
title='Curso'       
>
<?php if (isset ( $this->_tpl_vars['fields']['curso_c']['value'] ) && $this->_tpl_vars['fields']['curso_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['curso_c']['options'],'selected' => $this->_tpl_vars['fields']['curso_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['curso_c']['options'],'selected' => $this->_tpl_vars['fields']['curso_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['curso_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['curso_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['curso_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
" 
title='Curso'          
...
id="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['curso_c']['name'];  echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
');
<?php echo '
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['curso_c']['name'];  echo ' = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['curso_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['curso_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='modalidad_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MODALIDAD','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
" 
title='Modalidad de Curso'       
>
<?php if (isset ( $this->_tpl_vars['fields']['modalidad_c']['value'] ) && $this->_tpl_vars['fields']['modalidad_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['modalidad_c']['options'],'selected' => $this->_tpl_vars['fields']['modalidad_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['modalidad_c']['options'],'selected' => $this->_tpl_vars['fields']['modalidad_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['modalidad_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['modalidad_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
" 
title='Modalidad de Curso'          
...
id="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['modalidad_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['modalidad_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='horario_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_HORARIO','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
" 
title='Hora de Inicio'       
>
<?php if (isset ( $this->_tpl_vars['fields']['horario_c']['value'] ) && $this->_tpl_vars['fields']['horario_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['horario_c']['options'],'selected' => $this->_tpl_vars['fields']['horario_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['horario_c']['options'],'selected' => $this->_tpl_vars['fields']['horario_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['horario_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['horario_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['horario_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
" 
title='Hora de Inicio'          
...
id="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['horario_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['horario_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['horario_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['horario_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['horario_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['horario_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='contacto_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTO','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
" 
title='Medio de Contacto'       
>
<?php if (isset ( $this->_tpl_vars['fields']['contacto_c']['value'] ) && $this->_tpl_vars['fields']['contacto_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['contacto_c']['options'],'selected' => $this->_tpl_vars['fields']['contacto_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['contacto_c']['options'],'selected' => $this->_tpl_vars['fields']['contacto_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['contacto_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['contacto_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['contacto_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
" 
title='Medio de Contacto'          
...
id="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['contacto_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['contacto_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['contacto_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['contacto_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['contacto_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['contacto_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='hora_fin_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_HORA_FIN','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['hora_fin_c']['value'] ) && $this->_tpl_vars['fields']['hora_fin_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['hora_fin_c']['options'],'selected' => $this->_tpl_vars['fields']['hora_fin_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['hora_fin_c']['options'],'selected' => $this->_tpl_vars['fields']['hora_fin_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['hora_fin_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['hora_fin_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['hora_fin_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['hora_fin_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='fechacontacto_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_FECHACONTACTO','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<span class="required">*</span>
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<span class="dateTime">
<?php $this->assign('date_value', $this->_tpl_vars['fields']['fechacontacto_c']['value']); ?>
<input class="date_input" autocomplete="off" type="text" name="<?php echo $this->_tpl_vars['fields']['fechacontacto_c']['name']; ?>
" id="<?php echo $this->_tpl_vars['fields']['fechacontacto_c']['name']; ?>
" value="<?php echo $this->_tpl_vars['date_value']; ?>
" title='Fecha de Contacto'  tabindex='0'    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['fechacontacto_c']['name']; ?>
...
Calendar.setup ({
inputField : "<?php echo $this->_tpl_vars['fields']['fechacontacto_c']['name']; ?>
",
form : "EditView",
...
",
button : "<?php echo $this->_tpl_vars['fields']['fechacontacto_c']['name']; ?>
_trigger",
singleClick : true,
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='medio_enterado_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MEDIO_ENTERADO','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
" 
title='&amp;iquest;C&amp;oacute;mo nos conoci&amp;oacute;?'       
>
<?php if (isset ( $this->_tpl_vars['fields']['medio_enterado_c']['value'] ) && $this->_tpl_vars['fields']['medio_enterado_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['medio_enterado_c']['options'],'selected' => $this->_tpl_vars['fields']['medio_enterado_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['medio_enterado_c']['options'],'selected' => $this->_tpl_vars['fields']['medio_enterado_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['medio_enterado_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['medio_enterado_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
" 
title='&amp;iquest;C&amp;oacute;mo nos conoci&amp;oacute;?'          
...
id="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['medio_enterado_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<?php endif; ?>
<td valign="top" id='estatus_c_label' width='12.5%' scope="col">
<?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ESTATUS','module' => 'Contacts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
<?php echo smarty_function_counter(array('name' => 'fieldsUsed'), $this);?>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['estatus_c']['value'] ) && $this->_tpl_vars['fields']['estatus_c']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['estatus_c']['options'],'selected' => $this->_tpl_vars['fields']['estatus_c']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['estatus_c']['options'],'selected' => $this->_tpl_vars['fields']['estatus_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['estatus_c']['options']);  ob_start();  echo $this->_tpl_vars['fields']['estatus_c']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['estatus_c']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['estatus_c']['name'];  echo '");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:\'\'};
//get default
...
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-image');
SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
');
<?php echo '
function SyncToHidden(selectme){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['estatus_c']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['estatus_c']['name'];  echo ' = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['estatus_c']['name'];  echo '");
...
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.simulate(\'keyup\');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['estatus_c']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['estatus_c']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
addToValidate(\'EditView\', \'contacto_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACTO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'curso_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CURSO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'estatus_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ESTATUS','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'fechacontacto_c\', \'date\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FECHACONTACTO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'hora_fin_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HORA_FIN','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'horario_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_HORARIO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'medio_enterado_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MEDIO_ENTERADO','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modalidad_c\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODALIDAD','module' => 'Contacts','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'ultimo_c\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ULTIMO','module' => 'Contacts','for_js' => true), $this); echo '\' );
