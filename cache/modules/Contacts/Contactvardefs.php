 ...
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'contacto_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactscontacto_c',
    ...
    array (
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsestatus_c',
      'custom_module' => 'Contacts',
    ),
    'fechacontacto_c' => 
    array (
      'labelValue' => 'Fecha de Contacto',
      'required' => true,
      'source' => 'custom_fields',
      'name' => 'fechacontacto_c',
      'vname' => 'LBL_FECHACONTACTO',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      'comments' => '',
      'help' => 'Fecha de Contacto',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'display_default' => 'now',
      'id' => 'Contactsfechacontacto_c',
      'custom_module' => 'Contacts',
    ),
    'hora_fin_c' => 
    array (
      'labelValue' => 'Hora de Fin',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'hora_fin_c',
      'vname' => 'LBL_HORA_FIN',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'hora_fin_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactshora_fin_c',
      'custom_module' => 'Contacts',
    ),
    'horario_c' => 
    array (
      'labelValue' => 'Hora de Inicio',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'horario_c',
      'vname' => 'LBL_HORARIO',
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'horario_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactshorario_c',
      'custom_module' => 'Contacts',
    ),
    'medio_enterado_c' => 
    array (
      'labelValue' => '¿Cómo nos conoció?',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'medio_enterado_c',
      'vname' => 'LBL_MEDIO_ENTERADO',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      'comments' => '',
      'help' => '&iquest;C&oacute;mo nos conoci&oacute;?',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'medio_enterado_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsmedio_enterado_c',
      'custom_module' => 'Contacts',
    ),
    'modalidad_c' => 
    array (
      'labelValue' => 'Modalidad de Curso',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'modalidad_c',
      'vname' => 'LBL_MODALIDAD',
      ...
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Contactsmodalidad_c',
      'custom_module' => 'Contacts',
    ),
    'ultimo_c' => 
    array (
      'labelValue' => 'Último Contacto',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'ultimo_c',
      'vname' => 'LBL_ULTIMO',
      ...
      'default' => NULL,
      'no_default' => false,
      'comments' => 'Último Contacto',
      'help' => '&Uacute;ltimo Contacto',
      'importable' => 'true',
      'duplicate_merge' => 'disabled',
      'duplicate_merge_dom_value' => '0',
      'audited' => false,
