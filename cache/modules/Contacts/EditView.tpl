...
{capture name="label" assign="label"}{sugar_translate label='LBL_ULTIMO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if empty($fields.ultimo_c.value)}
{assign var="value" value=$fields.ultimo_c.default_value }
{else}
{assign var="value" value=$fields.ultimo_c.value }
{/if}  
<textarea  id='{$fields.ultimo_c.name}' name='{$fields.ultimo_c.name}'
rows="1" 
cols="40" 
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CURSO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
<select name="{$fields.curso_c.name}" 
id="{$fields.curso_c.name}" 
title='Curso'       
>
{if isset($fields.curso_c.value) && $fields.curso_c.value != ''}
{html_options options=$fields.curso_c.options selected=$fields.curso_c.value}
{else}
{html_options options=$fields.curso_c.options selected=$fields.curso_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.curso_c.options }
{capture name="field_val"}{$fields.curso_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.curso_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.curso_c.name}" 
id="{$fields.curso_c.name}" 
title='Curso'          
>
{if isset($fields.curso_c.value) && $fields.curso_c.value != ''}
...
<input
id="{$fields.curso_c.name}-input"
name="{$fields.curso_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.curso_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.curso_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.curso_c.name}-input', '{$fields.curso_c.name}');sync_{$fields.curso_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.curso_c.name}{literal}");
...
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.curso_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.curso_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.curso_c.name}');
{literal}
...
//global variable 
sync_{/literal}{$fields.curso_c.name}{literal} = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.curso_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.curso_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MODALIDAD' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.modalidad_c.name}" 
id="{$fields.modalidad_c.name}" 
title='Modalidad de Curso'       
>
{if isset($fields.modalidad_c.value) && $fields.modalidad_c.value != ''}
{html_options options=$fields.modalidad_c.options selected=$fields.modalidad_c.value}
{else}
{html_options options=$fields.modalidad_c.options selected=$fields.modalidad_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.modalidad_c.options }
{capture name="field_val"}{$fields.modalidad_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.modalidad_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.modalidad_c.name}" 
id="{$fields.modalidad_c.name}" 
title='Modalidad de Curso'          
>
{if isset($fields.modalidad_c.value) && $fields.modalidad_c.value != ''}
...
<input
id="{$fields.modalidad_c.name}-input"
name="{$fields.modalidad_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.modalidad_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.modalidad_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.modalidad_c.name}-input', '{$fields.modalidad_c.name}');sync_{$fields.modalidad_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.modalidad_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.modalidad_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.modalidad_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.modalidad_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.modalidad_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.modalidad_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.modalidad_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.modalidad_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.modalidad_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_HORARIO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.horario_c.name}" 
id="{$fields.horario_c.name}" 
title='Hora de Inicio'       
>
{if isset($fields.horario_c.value) && $fields.horario_c.value != ''}
{html_options options=$fields.horario_c.options selected=$fields.horario_c.value}
{else}
{html_options options=$fields.horario_c.options selected=$fields.horario_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.horario_c.options }
{capture name="field_val"}{$fields.horario_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.horario_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.horario_c.name}" 
id="{$fields.horario_c.name}" 
title='Hora de Inicio'          
>
{if isset($fields.horario_c.value) && $fields.horario_c.value != ''}
...
<input
id="{$fields.horario_c.name}-input"
name="{$fields.horario_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.horario_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.horario_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.horario_c.name}-input', '{$fields.horario_c.name}');sync_{$fields.horario_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.horario_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.horario_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.horario_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.horario_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.horario_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.horario_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.horario_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.horario_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.horario_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_CONTACTO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.contacto_c.name}" 
id="{$fields.contacto_c.name}" 
title='Medio de Contacto'       
>
{if isset($fields.contacto_c.value) && $fields.contacto_c.value != ''}
{html_options options=$fields.contacto_c.options selected=$fields.contacto_c.value}
{else}
{html_options options=$fields.contacto_c.options selected=$fields.contacto_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.contacto_c.options }
{capture name="field_val"}{$fields.contacto_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.contacto_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.contacto_c.name}" 
id="{$fields.contacto_c.name}" 
title='Medio de Contacto'          
>
{if isset($fields.contacto_c.value) && $fields.contacto_c.value != ''}
...
<input
id="{$fields.contacto_c.name}-input"
name="{$fields.contacto_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.contacto_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.contacto_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.contacto_c.name}-input', '{$fields.contacto_c.name}');sync_{$fields.contacto_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.contacto_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.contacto_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.contacto_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.contacto_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.contacto_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.contacto_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.contacto_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.contacto_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.contacto_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_HORA_FIN' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.hora_fin_c.name}" 
id="{$fields.hora_fin_c.name}" 
title=''       
>
{if isset($fields.hora_fin_c.value) && $fields.hora_fin_c.value != ''}
{html_options options=$fields.hora_fin_c.options selected=$fields.hora_fin_c.value}
{else}
{html_options options=$fields.hora_fin_c.options selected=$fields.hora_fin_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.hora_fin_c.options }
{capture name="field_val"}{$fields.hora_fin_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.hora_fin_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.hora_fin_c.name}" 
id="{$fields.hora_fin_c.name}" 
title=''          
>
{if isset($fields.hora_fin_c.value) && $fields.hora_fin_c.value != ''}
...
<input
id="{$fields.hora_fin_c.name}-input"
name="{$fields.hora_fin_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.hora_fin_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.hora_fin_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.hora_fin_c.name}-input', '{$fields.hora_fin_c.name}');sync_{$fields.hora_fin_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.hora_fin_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.hora_fin_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.hora_fin_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.hora_fin_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.hora_fin_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.hora_fin_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.hora_fin_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.hora_fin_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.hora_fin_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_FECHACONTACTO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
<span class="required">*</span>
</td>
{counter name="fieldsUsed"}
...
<span class="dateTime">
{assign var=date_value value=$fields.fechacontacto_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.fechacontacto_c.name}" id="{$fields.fechacontacto_c.name}" value="{$date_value}" title='Fecha de Contacto'  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.fechacontacto_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.fechacontacto_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.fechacontacto_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{capture name="label" assign="label"}{sugar_translate label='LBL_MEDIO_ENTERADO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.medio_enterado_c.name}" 
id="{$fields.medio_enterado_c.name}" 
title='&amp;iquest;C&amp;oacute;mo nos conoci&amp;oacute;?'       
>
{if isset($fields.medio_enterado_c.value) && $fields.medio_enterado_c.value != ''}
{html_options options=$fields.medio_enterado_c.options selected=$fields.medio_enterado_c.value}
{else}
{html_options options=$fields.medio_enterado_c.options selected=$fields.medio_enterado_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.medio_enterado_c.options }
{capture name="field_val"}{$fields.medio_enterado_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.medio_enterado_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.medio_enterado_c.name}" 
id="{$fields.medio_enterado_c.name}" 
title='&amp;iquest;C&amp;oacute;mo nos conoci&amp;oacute;?'          
>
{if isset($fields.medio_enterado_c.value) && $fields.medio_enterado_c.value != ''}
...
<input
id="{$fields.medio_enterado_c.name}-input"
name="{$fields.medio_enterado_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.medio_enterado_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.medio_enterado_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.medio_enterado_c.name}-input', '{$fields.medio_enterado_c.name}');sync_{$fields.medio_enterado_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.medio_enterado_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.medio_enterado_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.medio_enterado_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.medio_enterado_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.medio_enterado_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.medio_enterado_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.medio_enterado_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.medio_enterado_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.medio_enterado_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ESTATUS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
</td>
{counter name="fieldsUsed"}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.estatus_c.name}" 
id="{$fields.estatus_c.name}" 
title=''       
>
{if isset($fields.estatus_c.value) && $fields.estatus_c.value != ''}
{html_options options=$fields.estatus_c.options selected=$fields.estatus_c.value}
{else}
{html_options options=$fields.estatus_c.options selected=$fields.estatus_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.estatus_c.options }
{capture name="field_val"}{$fields.estatus_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.estatus_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.estatus_c.name}" 
id="{$fields.estatus_c.name}" 
title=''          
>
{if isset($fields.estatus_c.value) && $fields.estatus_c.value != ''}
...
<input
id="{$fields.estatus_c.name}-input"
name="{$fields.estatus_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.estatus_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.estatus_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.estatus_c.name}-input', '{$fields.estatus_c.name}');sync_{$fields.estatus_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
...
{literal}
(function (){
var selectElem = document.getElementById("{/literal}{$fields.estatus_c.name}{literal}");
if (typeof select_defaults =="undefined")
select_defaults = [];
select_defaults[selectElem.id] = {key:selectElem.value,text:''};
//get default
...
YUI().use("autocomplete", "autocomplete-filters", "autocomplete-highlighters", "node","node-event-simulate", function (Y) {
{/literal}
SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.estatus_c.name}-input');
SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.estatus_c.name}-image');
SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.estatus_c.name}');
{literal}
function SyncToHidden(selectme){
var selectElem = document.getElementById("{/literal}{$fields.estatus_c.name}{literal}");
var doSimulateChange = false;
...
//global variable 
sync_{/literal}{$fields.estatus_c.name}{literal} = function(){
SyncToHidden();
}
function syncFromHiddenToWidget(){
var selectElem = document.getElementById("{/literal}{$fields.estatus_c.name}{literal}");
...
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.simulate('keyup');
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.estatus_c.name}-input{literal}'))
SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("{/literal}{$fields.estatus_c.name}{literal}", syncFromHiddenToWidget);
{/literal}
SUGAR.AutoComplete.{$ac_key}.minQLen = 0;
SUGAR.AutoComplete.{$ac_key}.queryDelay = 0;
SUGAR.AutoComplete.{$ac_key}.numOptions = {$field_options|@count};
...
addToValidate('EditView', 'contacto_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CONTACTO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'curso_c', 'enum', false,'{/literal}{sugar_translate label='LBL_CURSO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'estatus_c', 'enum', false,'{/literal}{sugar_translate label='LBL_ESTATUS' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'fechacontacto_c', 'date', true,'{/literal}{sugar_translate label='LBL_FECHACONTACTO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'hora_fin_c', 'enum', false,'{/literal}{sugar_translate label='LBL_HORA_FIN' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'horario_c', 'enum', false,'{/literal}{sugar_translate label='LBL_HORARIO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'medio_enterado_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MEDIO_ENTERADO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'modalidad_c', 'enum', false,'{/literal}{sugar_translate label='LBL_MODALIDAD' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'ultimo_c', 'text', false,'{/literal}{sugar_translate label='LBL_ULTIMO' module='Contacts' for_js=true}{literal}' );
