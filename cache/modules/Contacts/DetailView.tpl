...
<span class="sugar_field" id="{$fields.ultimo_c.name|escape:'html'|url2html|nl2br}">{$fields.ultimo_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}</span>
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{if is_string($fields.curso_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.curso_c.name}" value="{ $fields.curso_c.options }">
{ $fields.curso_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.curso_c.name}" value="{ $fields.curso_c.value }">
{ $fields.curso_c.options[$fields.curso_c.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.modalidad_c.hidden}
...
{if is_string($fields.modalidad_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.modalidad_c.name}" value="{ $fields.modalidad_c.options }">
{ $fields.modalidad_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.modalidad_c.name}" value="{ $fields.modalidad_c.value }">
{ $fields.modalidad_c.options[$fields.modalidad_c.value]}
{/if}
{/if}
</td>
</tr>
...
{if is_string($fields.horario_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.horario_c.name}" value="{ $fields.horario_c.options }">
{ $fields.horario_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.horario_c.name}" value="{ $fields.horario_c.value }">
{ $fields.horario_c.options[$fields.horario_c.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.contacto_c.hidden}
...
{if is_string($fields.contacto_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.contacto_c.name}" value="{ $fields.contacto_c.options }">
{ $fields.contacto_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.contacto_c.name}" value="{ $fields.contacto_c.value }">
{ $fields.contacto_c.options[$fields.contacto_c.value]}
{/if}
{/if}
</td>
</tr>
...
{if is_string($fields.hora_fin_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.hora_fin_c.name}" value="{ $fields.hora_fin_c.options }">
{ $fields.hora_fin_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.hora_fin_c.name}" value="{ $fields.hora_fin_c.value }">
{ $fields.hora_fin_c.options[$fields.hora_fin_c.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.fechacontacto_c.hidden}
...
{if strlen($fields.fechacontacto_c.value) <= 0}
{assign var="value" value=$fields.fechacontacto_c.default_value }
{else}
{assign var="value" value=$fields.fechacontacto_c.value }
{/if}
<span class="sugar_field" id="{$fields.fechacontacto_c.name}">{$value}</span>
{/if}
</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.medio_enterado_c.hidden}
...
{if is_string($fields.medio_enterado_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.medio_enterado_c.name}" value="{ $fields.medio_enterado_c.options }">
{ $fields.medio_enterado_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.medio_enterado_c.name}" value="{ $fields.medio_enterado_c.value }">
{ $fields.medio_enterado_c.options[$fields.medio_enterado_c.value]}
{/if}
{/if}
</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.estatus_c.hidden}
...
{if is_string($fields.estatus_c.options)}
<input type="hidden" class="sugar_field" id="{$fields.estatus_c.name}" value="{ $fields.estatus_c.options }">
{ $fields.estatus_c.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.estatus_c.name}" value="{ $fields.estatus_c.value }">
{ $fields.estatus_c.options[$fields.estatus_c.value]}
{/if}
{/if}
</td>
</tr>
